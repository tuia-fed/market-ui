...
export default {
  Red: {
    ...
    foundationImg: {
      ...
      remark: '底座图片',
      default:
        '//yun.tuisnake.com/market-ui/04d07f3b-87d1-4434-830b-70cbadbaf111.png',
    },
  },
  Yellow: {
    containerImg: {
    ...
    foundationImg: {
      ...
      remark: '底座图片',
      default:
        '//yun.tuisnake.com/market-ui/90039276-7458-4c67-a9af-4b6430d7225e.png',
    },
    extraRotate: {
      type: Number,
  ...
  Blue: {
    ...
    foundationImg: {
      ...
      remark: '底座图片',
      default:
        '//yun.tuisnake.com/market-ui/a6c4e7e5-e9a1-471a-a8bc-c1995172ad99.png',
    },
    extraRotate: {
      type: Number,
      remark: '初始转盘上奖品相对于转盘需要额外转动的度数',
  ...
  Green: {
    ...
    foundationImg: {
      ...
      remark: '底座图片',
      default:
        '//yun.tuisnake.com/market-ui/79fe79e8-6a8c-4139-85fe-de36861c0cbb.png',
    },
    extraRotate: {
      type: Number,
      remark: '初始转盘上奖品相对于转盘需要额外转动的度数',
