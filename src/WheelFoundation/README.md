...
基座大转盘是[大转盘](../Wheel)的**变体**（变体的详细说明可以查看[变体与预设](../../guide/presets)），其支持大转盘的大部分能力，当然也支持**不均分**转盘，也属于`可控组件`（详细说明可查看[基础玩法组件逻辑规范](../../guide/basic-rule)）

另外，一个基座大转盘主要由大转盘的基本元素（**底盘**、**灯光**、**转盘**、**指针**、**开始按钮**）和**基座**等组成
## 按需引入
...
// 使用红色预设，组件名字也为 mk-wheel-foundation
Vue.use(WheelFoundation.Presets.Red)
```
...
| 名称 | 使用 | 配置 |
| --- | --- | --- |
| 红色 | `WheelFoundation.Presets.Red` | 待补充 |
| 黄色 | `WheelFoundation.Presets.Yellow` | 待补充 |
| 蓝色 | `WheelFoundation.Presets.Blue` | 待补充 |
| 绿色 | `WheelFoundation.Presets.Green` | 待补充 |
...
| foundationImg | 底座图片 | _string_ | `//yun.tuisnake.com/market-ui/8a636ef9-2a48-4c47-b817-1806bfe0ba03.png` |
