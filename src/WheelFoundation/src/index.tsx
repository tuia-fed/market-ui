...
export default BasicBase.extend({
  ...
  props: {
    containerImg: {
      type: String,
      remark: '底盘图片',
      default: '//yun.tuisnake.com/market-ui/e7185b56-1757-40f7-a921-f8c818d4c1a7.png'
    },
    lightImg: {
      type: String,
      remark: '灯图片',
    ...
    pointImg: {
      type: String,
      remark: '箭头图片',
      default: '//yun.tuisnake.com/market-ui/0b7f2b9d-c63f-46fc-a851-edc2d47df9ab.png'
    },
    btnImg: {
      type: String,
      remark: '按钮图片',
      default: '//yun.tuisnake.com/market-ui/db4540bd-8c5a-439d-bbb6-ea3f114c4902.png'
    },
    btnDisableImg: {
      type: String,
      remark: '按钮不可用图片',
      default: '//yun.tuisnake.com/market-ui/11c22d77-2e83-405b-85e8-c8832dc78529.png'
    },
    foundationImg: {
      type: String,
      remark: '底座图片',
      default: '//yun.tuisnake.com/market-ui/8a636ef9-2a48-4c47-b817-1806bfe0ba03.png'
    },
    handStyle: {
    ...
    handImg: {
      type: String,
      remark: '手势图片',
      default: '//yun.tuisnake.com/tact/turnCircle/bcb4fc7e-18c1-46d7-bdae-2e91147196c1.png'
    },
    prizeList: {
  ...
  methods: {
    ...
    getState() { return this.wheel.getState() },
    start(opts?: any) { return this.wheel.start(opts) },
    stop(opts?: any) { return this.wheel.stop(opts) },
    reset(opts?: any) { return this.wheel.reset(opts) },
    disable(opts?: any) { return this.wheel.disable(opts) },
  },
  ...
  render() {
    return (
      <div class="mk-wheel-foundation" style={this.containerStyle}>
        ...
        <div class="mk-wheel-foundation__foundation"  style={this.foundationStyleData}></div>
      </div>
    );
  }
});
