  ...
  computed: {
    ...
    lightStyleData (): StyleType {
      return {
        ...
        left: this.addUnitFunc((+this.containerStyle.width - +this.lightStyle.width) / 2),
    ...
    pointStyleData (): StyleType {
      return {
        ...
        left: this.addUnitFunc((+this.containerStyle.width - +this.pointStyle.width) / 2),
    ...
    btnStyleData (): StyleType {
      ...
      return {
        ...
        left: this.addUnitFunc((+this.containerStyle.width - +this.btnStyle.width) / 2),
